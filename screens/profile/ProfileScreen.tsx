...
import VolunteerTab from "components/profileScreen/VolunteerTab";
  ...
  if (isLoading || !user) {
    ...
    return (
      <>
        ...
        {user.role === Role.Volunteer && <ProfileTabViewer profile={userProfile} contacts={Contacts} volunteer={VolunteerTab}/>}
