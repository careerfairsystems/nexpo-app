...
export default function VolunteerTab() {
  ...
  // refactor to work with multiple messages when API is ready
  ...
  const onPress = () => {
    setMessagePressed([!messagePressed[0]])
  }
  ...
  return (
    <FlatList
      ...
      <View style={messagePressed[0] ? styles.messageBoxPressed : styles.messageBoxNotPressed}>
        <MessageListItem message={message} itemStyle={{}} onPress={onPress} />
      </View>
      )}
    />
  );
