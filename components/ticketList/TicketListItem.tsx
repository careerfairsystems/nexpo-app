    ...
    <View style={styles.footerContainer}>
      <ArkadText
        ...
        text={API.events.formatTime(
          ticketItem.event.date,
          ticketItem.event.start,
          ticketItem.event.end
        )}
      />
      <View style={[styles.eventBookedContainer, { backgroundColor: Colors.lightGreen }]}>
        <ArkadText style={styles.eventBookedText} text="1 ticket" />
      </View>
    </View>
  </Pressable>
);
