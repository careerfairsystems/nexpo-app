    ...
    <View style={styles.left}>
      ...
      {application.studentProgramme && (
        <ArkadText
          ...
          text={Programme[application.studentProgramme]
            .replace("_", " ")
            .replace("_", " ")
            .replace("_", " ")
            .replace("_", " ")}
      ...
      {application.studentYear && (
        <ArkadText style={styles.programAndYear} text={`Year ${application.studentYear}`} />
      )}
    </View>
    {/* Color of box changes depending on status */}
    {application.status === 1 ? (
      <View style={[styles.applicationStatusContainer, { backgroundColor: Colors.lightGreen }]}>
        <ArkadText style={styles.applicationStatusText} text="Accepted" />
      </View>
    ) : (
      <View
        style={[
